    ...
    private fun carregarDadosIniciais() {
        viewModelScope.launch {
            ...
            try {
                ...
                _erroDadosIniciais.postValue("Não foi possível carregar espécies ou raças.")
    ...
    fun salvarAnimal(animal: Animal) {
        viewModelScope.launch {
            ...
            try {
                ...
                _actionError.postValue("Erro de conexão. Verifique sua internet.")
            } catch (e: Exception) {
                Log.e("CadastroAnimalVM", "Erro ao salvar animal", e)
                _actionError.postValue(e.message ?: "Ocorreu um erro desconhecido.")
            } finally {
    ...
    fun removerAnimal(animalId: Long) {
        viewModelScope.launch {
            ...
            try {
                ...
                _actionError.postValue(e.message ?: "Não foi possível remover o animal.")
            } finally {
                _isLoading.value = false
            }
        }
